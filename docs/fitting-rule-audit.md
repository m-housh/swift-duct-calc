# Production fitting rule audit

The initial Swift catalog packages 231 definitions for all eligible groups. It
...
and packages identities/artwork from the manifests. It does not execute or copy
