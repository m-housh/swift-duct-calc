...
- One bundled JSON resource provides canonical group order/eligibility and 165
  ...
  [square elbows, offsets, and risers](fitting-client-offsets.md).
...
The expansion audits record numeric coverage for all 165 current fitting choices.
