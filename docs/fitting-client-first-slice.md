...
- One bundled JSON resource provides canonical group order/eligibility and 155
  ...
  [completed 8A constructions](fitting-client-8a-constructions.md).
...
The expansion audits record numeric coverage for all 155 current fitting choices.
