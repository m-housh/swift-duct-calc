...
public struct PathTemplate: Codable, Equatable, Identifiable, Sendable {
  ...
  public struct Step: Codable, Equatable, Identifiable, Sendable {
    ...
    public var group: Fitting.Group
    public var behavior: Behavior
    public var allowsSkipping: Bool
    public var choices: [Choice]

    public init(
      id: UUID, title: String, group: Fitting.Group, behavior: Behavior = .chooseOne,
  ...
  public struct Choice: Codable, Equatable, Sendable {
    ...
    public var defaults: Fitting.Inputs?

    public init(fittingID: Fitting.ID, defaults: Fitting.Inputs? = nil) {
