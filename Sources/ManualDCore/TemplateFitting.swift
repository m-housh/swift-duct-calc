...
public enum TemplateFitting {
  public typealias ID = Tagged<TemplateFitting, String>
  ...
  public struct Calculation: Codable, Equatable, Sendable {
    ...
    public let catalogCalculation: Fitting.Calculation?
    public init(
      fittingID: ID, inputs: Inputs, equivalentLengthFeet: Double, ruleRevision: String,
      catalogCalculation: Fitting.Calculation? = nil
    ) {
      self.fittingID = fittingID
      self.inputs = inputs
      self.equivalentLengthFeet = equivalentLengthFeet
      self.ruleRevision = ruleRevision
      self.catalogCalculation = catalogCalculation
    }
  }
